  ...
  <div class="min-h-screen bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div class="mb-10">
        ...
        <p class="text-lg text-gray-500">Просмотрите свои товары перед оформлением заказа</p>
      </div>
      ...
      <div v-else-if="!cartStore.hasItems" class="text-center py-16">
        ...
        <p class="text-lg text-gray-500 mb-8">Добавьте несколько продуктов, чтобы начать работу!</p>
        <router-link
          to="/"
      ...
      <div v-else class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-1">
          <div class="bg-white border-2 border-gray-100 rounded-none p-8 shadow-sm sticky top-24">
            <h2 class="text-2xl font-bold text-black mb-8">Описание заказа</h2>

            <!-- Детали заказа -->
            <div class="space-y-6 mb-8">
              <div class="flex justify-between text-lg text-gray-600">
                <span>Товары ({{ cartStore.cartDetails?.items_count }})</span>
...
function handleClearCart() {
  if (confirm('Вы точно хотите отчистить корзину?')) {
    cartStore.clearCart()
  }
}
